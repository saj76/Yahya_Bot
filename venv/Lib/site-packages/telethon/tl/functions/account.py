...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureValueType, TypeInputPeerNotifySettings, TypeInputNotifyPeer, TypeSecureCredentialsEncrypted, TypeInputPeer, TypeAccountDaysTTL, TypeInputSecureValue, TypeInputPrivacyRule, TypeSecureValueHash, TypeReportReason, TypeInputPrivacyKey, TypeBool
