...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputStickerSet, TypeInputChatPhoto, TypeInputMessage, TypeInputChannel, TypeChannelAdminRights, TypeChannelParticipantsFilter, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeBool
