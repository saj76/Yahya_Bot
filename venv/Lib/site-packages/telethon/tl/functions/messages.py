...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputBotInlineMessageID, TypeInputUser, TypeInputMessage, TypeReplyMarkup, TypeInputStickeredMedia, TypeInputEncryptedFile, TypeShippingOption, TypeInlineBotSwitchPM, TypeInputMedia, TypeInputSingleMedia, TypeReportReason, TypeInputBotInlineResult, TypeInputDialogPeer, TypeBool, TypeSendMessageAction, TypeInputPeer, TypeMessagesFilter, TypeInputGeoPoint, TypeInputStickerSet, TypeInputChatPhoto, TypeMessageEntity, TypeInputDocument
