...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeImportedContact, TypePopularContact, TypeContactLink, TypeContact, TypePeer, TypeTopPeerCategoryPeers, TypeContactBlocked, TypeChat
