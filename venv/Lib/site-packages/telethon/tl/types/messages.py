...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeStickerPack, TypeInlineBotSwitchPM, TypeFoundGif, TypeChatFull, TypeStickerSetCovered, TypeStickerSet, TypeBotInlineResult, TypeDialog, TypeDocument, TypeHighScore, TypeMessage, TypeChat, TypeEncryptedFile
